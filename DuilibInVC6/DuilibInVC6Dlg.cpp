// DuilibInVC6Dlg.cpp : implementation file
//
...
void CDuilibInVC6Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
...
/////////////////////////////////////////////////////////////////////////////
// CDuilibInVC6Dlg message handlers

BOOL CDuilibInVC6Dlg::OnInitDialog()
{
	...
	m_MainDui.Create(*this, _T("Ö÷½çÃæ"), UI_WNDSTYLE_CHILD, 0, 0, 0, 300, 200); 
...
void CDuilibInVC6Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
