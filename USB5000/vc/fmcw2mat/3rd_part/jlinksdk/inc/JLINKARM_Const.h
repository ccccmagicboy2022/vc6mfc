...
#define JLINKARM_TIF_CJTAG             7  // Not implemented yet, just reserved the TIF number
...
typedef struct {
  ...
  JLINK_FLASH_BANK_INFO   aFlashBank[16];         // Only interesting for J-Flash. Other applications can safely ignore this
