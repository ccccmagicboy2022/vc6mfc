...
*
* wolar@qq.com
* http://miniblink_demoblink.net
* https://github.com/weolar/miniblink_demoblink49
* https://weolar.github.io/miniblink_demoblink/doc-main.html api文档地址
* licence Apache-2.0
*
*/
...
typedef struct {
    ...
    wkeString filePath;
    long fileStart;
    long fileLength; // -1 means to the end of the file.
} wkePostBodyElement;
