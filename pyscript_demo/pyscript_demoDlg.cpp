// pyscript_demoDlg.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// Cpyscript_demoDlg dialog

Cpyscript_demoDlg::Cpyscript_demoDlg(CWnd* pParent /*=NULL*/) : CDialog(Cpyscript_demoDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(Cpyscript_demoDlg)
...
void Cpyscript_demoDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(Cpyscript_demoDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP

}

BEGIN_MESSAGE_MAP(Cpyscript_demoDlg, CDialog)
	//{{AFX_MSG_MAP(Cpyscript_demoDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// Cpyscript_demoDlg message handlers

BOOL Cpyscript_demoDlg::OnInitDialog()
{
...
void Cpyscript_demoDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
// If you add a pyscript_demomize button to your dialog, you will need the code below
//  to draw the icon.  For MFC applications using the document/view model,
//  this is automatically done for you by the framework.

void Cpyscript_demoDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  the pyscript_demomized window.
HCURSOR Cpyscript_demoDlg::OnQueryDragIcon()
{
...
void Cpyscript_demoDlg::init_pyscript_demo()
{
	CString strFileName;
	...
	wkeSetWindowTitleW(this->window, L"pyscript_demo_cccc");
...
void Cpyscript_demoDlg::OnSize(UINT nType, int cx, int cy)
{
...
void Cpyscript_demoDlg::controls_change_size()
{
	CRect rc;
	GetClientRect(rc);
...
void Cpyscript_demoDlg::OnGetMinMaxInfo(MINMAXINFO FAR* lpMMI)
{
	CPoint pt(1024, 768);		//
...
void Cpyscript_demoDlg::OnCancel()
{
	OnClose();
}

void Cpyscript_demoDlg::OnOK()
{
	//
}

void Cpyscript_demoDlg::OnClose()
{
	DWORD result;
...
void Cpyscript_demoDlg::WinHelp(DWORD dwData, UINT nCmd)
{
	//
}
